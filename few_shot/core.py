...
class NShotTaskSampler(Sampler):
    def __init__(self,
        ...
        """Paddle Sampler subclass that generates batches of n-shot, k-way, q-query tasks.
        ...
        # Arguments
            dataset: Instance of paddle.io.Dataset from which to draw samples
...
class EvaluateFewShot(Callback):
    ...
    def __init__(self,
                 ...
                 k_way: int,
                 q_queries: int,
                 taskloader: paddle.io.DataLoader,
...
def prepare_nshot_task(n: int, k: int, q: int) -> Callable:
    ...
    """
    def prepare_nshot_task_(batch: Tuple[paddle.Tensor, paddle.Tensor]) -> Tuple[paddle.Tensor, paddle.Tensor]:
